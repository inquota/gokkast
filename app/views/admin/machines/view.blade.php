            ...
            <div class="panel-body">
                ...
                <table id="sample-table-1" class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="hidden-xs">&euro; {{$stand->b_stand}}</td>
                            ...
                            <div class="visible-xs visible-sm hidden-md hidden-lg">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right dropdown-dark" role="menu">
                                        <li>
                                            <a href="/admin/machines/view/{{$stand->id}}" tabindex="-1" role="menuitem">
                                                <i class="fa fa-edit"></i> View
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/admin/machines/edit/{{$stand->id}}" tabindex="-1" role="menuitem">
